                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _ChoiceRow<ThemeMode>(
                      options: [
                        _Choice(
                          label: S.of(context).settingsThemeLight,
                          value: ThemeMode.light,
                        ),
                        _Choice(
                          label: S.of(context).settingsThemeDark,
                          value: ThemeMode.dark,
                        ),
                        _Choice(
                          label: S.of(context).settingsThemeSystem,
                    ...
                    _ChoiceRow<Locale>(
                      options: [
                        _Choice(
                          label: S.of(context).settingsLanguageEnglish,
                          value: const Locale('en'),
                        ),
                        _Choice(
                          label: S.of(context).settingsLanguageArabic,
                    ...
                    _SettingsRow(
                      ...
                      description:
                          S.of(context).settingsLocationDescription,
                    ...
                    _SettingsRow(
                      ...
                      description:
                          S.of(context).settingsPermissionsDescription,
                      onTap: () {},
                      cardColor: cardColor,
                      primaryText: primaryText,
                      secondaryText: secondaryText,
                    ...
                    _SettingsRow(
                      ...
                      description:
                          S.of(context).settingsAboutDescription,
                      onTap: () {},
                      cardColor: cardColor,
                      primaryText: primaryText,
                      secondaryText: secondaryText,
